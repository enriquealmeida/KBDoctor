    ...
    static class KbStats
    {
            ...
            try
            {
                ...
                foreach (KBObject obj in kbserv.CurrentModel.Objects.GetAll())
                {
                    ...
                    if (KBDoctorCore.Sources.Utility.isGenerated(obj) && (obj is WebPanel || obj is Transaction || obj is WorkPanel || obj is DataSelector))
                    {
                        ...
                        {
                            ObjNoPattern += 1;
                            writer.AddTableData(new string[] { Utility.linkObject(obj), obj.TypeDescriptor.Name, obj.Description });
                        }
                ...
                Utility.AddLineSummary("SummaryPatternGeneration.txt", texto);
        ...
        public static void ListObj()
        {
            ...
            try
            {
               ...
               // KBDoctorOutput.Message( "Fecha Limite : " + limite.ToString());
                ...
                {
                    if (obj != null)
                        if (Utility.isRunable(obj) && KBDoctorCore.Sources.Utility.isGenerated(obj))
                        {
                            ...
                            writer.AddTableData(new string[] { obj.TypeDescriptor.Name +" ", Utility.linkObject(obj), desc,
        ...
        public static void ListMainObj()
        {
            ...
            try
            {
                ...
                KBCategory mainCategory = Utility.MainCategory(kbserv.CurrentModel);
            ...
            try
            {
                ...
                foreach (KBObject obj in kbmodel.Objects.GetAll())
                {
                    ...
                    if (obj is Procedure)
                    {
                        ...
                        writer.AddTableData(new string[] { obj.TypeDescriptor.Name +" ", Utility.linkObject(obj), commitOnExit ,
        ...
        public static void List2(KBObject obj, string objLocation, Dictionary<string, KBObjectCollection> dic,KBDoctorXMLWriter writer)
        {
            ...
            writer.AddTableData(new string[] { obj.TypeDescriptor.Name, Utility.linkObject(obj), objLocation, objMasterPage });
                ...
                foreach (EntityReference reference in obj.GetReferences())
                {
                    ...
                    if ((objRef != null) && list.Contains(typeDescriptor) && (reference.ReferenceType == ReferenceType.Hard))
                    {
                        ...
                        if (count > 0)
                        {
                            ...
                            writer.AddTableData(new string[] { "+-----Called >>" + objRef.TypeDescriptor.Name, Utility.linkObject(objRef), count.ToString() + "-" + locations, objRefMasterPage });
                        }
                    }
                }
            }
      ...
      //      SpecificationListHelper helper = new SpecificationListHelper(design.Environment.TargetModel);
                        ...
                        if (count > 1)
                        {
                            ...
                            foreach (EntityReference reference in obj.GetReferences())
                            {
                                ...
                                if ((objRef != null) && (objRef is WorkPanel || objRef is WebPanel) && (reference.ReferenceType == ReferenceType.Hard)) //&& (objRef.TypeDescriptor.Name != "MasterPage") ) 
                                {
                                    ...
                                    writer.AddTableData(new string[] { Utility.linkObject(obj), Utility.linkObject(objRef), mainss });
        ...
        public static string MainsOf(KBObject obj, KBObjectCollection objColl, string callTree)
        {
            ...
            if (!objColl.Contains(obj))
            {
                ...
                if (obj.GetPropertyValue<bool>("IsMain"))
                {
                    ...
                    { mains = callTree + "/" + Utility.linkObject(obj) + "(" + objAppGenerator + ")<BR> "; }
            ...
            foreach (KBObject obj in kbserv.CurrentModel.Objects.GetAll())
            {
                ...
                if (obj != null)
                {
                 ...
                 //   IEnumerable<int> generatorTypes = KbStats.GetObjectGenerators(obj.Key);
                    ...
                    foreach (EntityReference reference in obj.GetReferences())
                    {
                        ...
                        if (objRef != null)
                        {
                            if (objRef is ExternalObject)
                            {
                                ...
                                writer.AddTableData(new string[] { obj.TypeDescriptor.Name, Utility.linkObject(obj), Utility.linkObject(objRef), tipo, obj.Module.Name });
                            }
                            else
                            {
                    ...
                    string sourceWOComments = Utility.ExtractComments(Utility.ObjectSourceUpper(obj));
        ...
        private static void AddLineKBInterfazSource( KBDoctorXMLWriter writer, KBObject obj, string texto, string tipo, string sourceWOComments, string mainss)
        {
            ...
            {
                writer.AddTableData(new string[] { obj.TypeDescriptor.Name, Utility.linkObject(obj), "", "CMD." + texto, obj.Module.Name });
            }
                ...
                if (vp != null)
                {
                    foreach (Variable v in vp.Variables)
                    {
                        ...
                        if ((!v.IsStandard) && (v.AttributeBasedOn == null) && (type == "GX_USRDEFTYP")) //|| (type==) || (type == "GX_BUSCOMP_LEVEL") )
                        {
                            ...
                            writer.AddTableData(new string[] { obj.TypeDescriptor.Name, Utility.linkObject(obj), name, "Data Type." + txtDimensions, obj.Module.Name });
            ...
            if (webpart != null)
            {
                foreach (Artech.Genexus.Common.Parts.WebForm.IWebTag tag in Artech.Genexus.Common.Parts.WebForm.WebFormHelper.EnumerateWebTag(webpart))
                {
                    if (tag.IsUserControl)
                    {
                        ...
                        writer.AddTableData(new string[] { obj.TypeDescriptor.Name, Utility.linkObject(obj), ctrlName, "UC." + ucType, mainss });
                    }
                }
            }
        }
