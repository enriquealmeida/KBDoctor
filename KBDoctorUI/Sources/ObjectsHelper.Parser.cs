...
namespace Concepto.Packages.KBDoctor
{
    partial class ObjectsHelper
    {
        ...
        public enum TokensIds
        {
            ...
            TKN_TRUE, // TRUE
            TKN_FALSE, // FALSE
            TKN_NONE, // NONE, para expresi�n FOR EACH ... ORDER NONE ... ENDFOR
            PRM,  // Par�metro, utilizado en DYNQ
            FND,  // Name Domain
            FLV,  // LEVEL token
            TKN_NEW, // NEW token
            ...
            DTEFF,
            DTLNK, // Comando LINK
            DTAPL, // Asignaci�n del tipo +=
            DTAMI, // Asignaci�n del tipo -=
            DTAMU, // Asignaci�n del tipo *=
            DTADI, // Asignaci�n del tipo /=
