...
namespace Concepto.Packages.KBDoctorCore {
    ...
    internal class StringResources {
        ...
        /// * $Rev: 4663 $
        /// */
        ///(function(){if(window.jQuery)var _jQuery=window.jQuery;var jQuery=window.jQuery=function(selector,context){return new jQuery.prototype.init(selector,context);};if(window.$)var _$=window.$;window.$=jQuery;var quickExpr=/^[^&lt;]*(&lt;(.|\s)+&gt;)[^&gt;]*$|^ [rest of string was truncated]&quot;;.
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to call mailsend -to &quot;%emailto%@&lt;dominio&gt;.com&quot; -from %emailfrom% -ssl -port %port% -auth -smtp %smtp% -sub &quot;Review Commits - KBDoctor&quot; -user %emailfrom% -pass %email_pass% -attach %attach%.
        /// </summary>
